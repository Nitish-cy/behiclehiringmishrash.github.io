<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OTP.aspx.cs" Inherits="Seller_OTP" %>
                    ...
                    <form id="Form1" runat="server">
                        <div class="form-group form-box">
                           <%-- <input type="email" name="email" class="input-text" placeholder="Email Address">--%>
                            <asp:TextBox ID="txtotp" runat="server" class="input-text" placeholder="Enter Otp"></asp:TextBox>
                        </div>
                      
                        <div class="form-group clearfix mb-0">
                         <%--   <button type="submit" class="btn-md btn-theme btn float-left">Login</button>--%>
                          <asp:Button ID="btnreg" runat="server" Text="Verify" 
