<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forgot-password.aspx.cs" Inherits="Seller_forgot_password" %>
                    ...
                    <form id="Form1" runat="server">
                        <div class="form-group form-box">
                           <%-- <input type="email" name="email" class="input-text" placeholder="Email Address">--%>
                            <asp:TextBox ID="txtemail" runat="server" class="input-text" placeholder="Enter Email"></asp:TextBox>
                        </div>
                      
                        <div class="form-group clearfix mb-0">
                         <%--   <button type="submit" class="btn-md btn-theme btn float-left">Login</button>--%>
                          <asp:Button ID="btnreg" runat="server" Text="Forgot" 
                                class="btn-md btn-theme float-left" onclick="btnreg_Click"  />
                                <br />
                            <asp:Label ID="lblpass" runat="server" Text="">Password is Here...</asp:Label>
