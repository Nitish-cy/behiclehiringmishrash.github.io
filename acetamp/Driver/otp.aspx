<%@ Page Language="C#" AutoEventWireup="true" CodeFile="otp.aspx.cs" Inherits="Driver_otp" %>
    ...
    <div class="content">
        <div class="brand">
         ...
         <form id="Form1" runat="server">
            <h2 class="login-title">OTP PAGE</h2>
            
                    <div class="form-group">
                    <div class="input-group-icon right">
                    <div class="input-icon"><i class="fa fa-lock"></i></div>
                       <%-- <input class="form-control" type="text" name="first_name" placeholder="First Name">--%>
                       <asp:TextBox ID="txtotp" runat="server" placeholder="Enter Otp" class="form-control" autocomplete="off"></asp:TextBox>
                    </div>
                    </div>
            ...
            <div class="form-group">
               <%-- <button class="btn btn-info btn-block" type="submit">Sign up</button>--%>
                <asp:Button ID="btnsub" runat="server" Text="Verify"  
