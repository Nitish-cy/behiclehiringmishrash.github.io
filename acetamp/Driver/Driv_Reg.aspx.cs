...
public partial class Driver_Driv_Reg : System.Web.UI.Page
{
    ...
    protected void btnsub_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            ...
            FileUpload1.SaveAs(Server.MapPath("~/profile2/" + f1));
            Random rnd = new Random();
            string ranNumber = rnd.Next(0, 9999).ToString();
            cn.Open();
            qry = "insert into Driver_Reg_Mstr values('" + txtname.Text + "','" + txtemail.Text + "','" + txtpass.Text + "','" + txtconpass.Text + "','" + txtmob.Text + "','" + txtadhar.Text + "','" + txtadd.Text + "','" + ddlcountry.Text + "','" + ddlstate.Text + "','" + ddlcity.Text + "','" + ranNumber + " ',0 ,'" + f1 + "' )";
