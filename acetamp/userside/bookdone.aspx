			...
			<div class="x_car_donr_main_box_wrapper_inner">
				<div class="order-done"> <i class="icon-checked"><img src="images/icon-checked.png" alt=""></i>
					...
					<ul class="row list-unstyled">
						...
						<li class="col-md-6">
							<h6>Location</h6>
							<p>Pick-Up <span><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span>
							</p>
							<p>Drop-off <span><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></span>
							</p>
						</li>
						<li class="col-md-6">
							<h6>Car</h6>
						...
						<li class="col-md-6">
							<h6>Add-ons</h6>
							<p>Person <span><asp:Label ID="Label12" runat="server" Text="Label"></asp:Label></span>
							</p>
							<p>Luggage <span><asp:Label ID="Label13" runat="server" Text="Label"></asp:Label></span>
							</p>
						</li>
						<li class="col-md-6">
							<h6>Taxes & Fees</h6>
						...
						<li class="col-md-6">
							...
							<p>Payment on Arrival <span><asp:Label ID="Label4" runat="server" Text=""></asp:Label></span>
							</p>
						</li>
						<li class="col-md-12">
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="CarListing.aspx">Click On Done</asp:HyperLink>
					<hr>
