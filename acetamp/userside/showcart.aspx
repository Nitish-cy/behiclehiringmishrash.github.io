<%@ Page Title="" Language="C#" MasterPageFile="~/userside/MasterPage.master" AutoEventWireup="true" CodeFile="showcart.aspx.cs" Inherits="userside_Default2" %>
            ...
            <div class="row">
                           ...
                           <tbody>
                              <tr class="shop-cart-item">
                                 <td class="gauto-cart-preview">
                                    <a href="#">
                                    <img src='../profile/<%#Eval("image") %>' alt="cart-1">
                                    </a>
                                 </td>
               ...
               <div class="col-lg-4">
                  ...
                  <div class="checkout-action">
                     <a href="../seller/checkout.aspx" class="gauto-btn">Proceed to checkout</a>
                  </div>
               </div>
            </div>
         </div>
