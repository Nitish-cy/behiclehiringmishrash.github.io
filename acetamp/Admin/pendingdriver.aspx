<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="pendingdriver.aspx.cs" Inherits="Admin_Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        CellPadding="3" DataKeyNames="DriverId" DataSourceID="SqlDataSource1" 
        EmptyDataText="There are no data records to display." ForeColor="Black" 
        GridLines="Vertical" Height="147px" Width="1205px"   CssClass="table table-striped table-borderedtable-hover">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [DriverId], [DriverName], [Email], [Password], [ConPassword], [MobileNo], [AdharNumber], [Address], [Country], [State], [City], [OTP], [Status], [Prifile] FROM [Driver_Reg_Mstr] where Status=0" 
